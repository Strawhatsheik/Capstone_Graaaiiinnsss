...
AZombieAIController::AZombieAIController()
{
	...
	{	//Pass info of hit componentto debugger to be displayed on screen
		GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Green, FString::Printf(TEXT("I am getting sense")));
	}
...
void AZombieAIController::BeginPlay()
{
	...
	if (GEngine)
	{	//Pass info of hit componentto debugger to be displayed on screen
		GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Green, FString::Printf(TEXT("I am a zombie!!")));
	}
}
...
// DamageCollider component.
	...
	{	//Pass info of hit componentto debugger to be displayed on screen
		...
		GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Red, FString::Printf(TEXT("I am POSSESED")));
	}
}
...
void AZombieAIController::OnTargetPerceptionUpdate(AActor* Actor, FAIStimulus Stimulus)
{
	...
	if (!bPlayerIsInSight)
	{
		...
		{	//Pass info of hit componentto debugger to be displayed on screen
			...
			GEngine->AddOnScreenDebugMessage(-2, 10.f, FColor::Red, FString::Printf(TEXT("I lost sight")));
		}
		StopChase();
	...
	if (Zombie_Cow->State == ZombieStates::CHASE)
	{
		...
		{	//Pass info of hit componentto debugger to be displayed on screen
			...
			GEngine->AddOnScreenDebugMessage(-3, 15.f, FColor::Red, FString::Printf(TEXT("I am CHASING ALREADYY")));
		}
		return;
	...
	if (PlayerCharacter == nullptr)
	{
		...
		{	//Pass info of hit componentto debugger to be displayed on screen
			...
			GEngine->AddOnScreenDebugMessage(-4, 10.f, FColor::Red, FString::Printf(TEXT("Your NOT a zombie")));
		}
		return;
	...
	{	//Pass info of hit componentto debugger to be displayed on screen
		...
		GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Red, FString::Printf(TEXT("I SEE YOU")));
		//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Purple, text);
	}
...
void AZombieAIController::Roam()
{
	...
	{	//Pass info of hit componentto debugger to be displayed on screen
		...
		GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Red, FString::Printf(TEXT("I'm going to roam around and look for GRAIINNNSS nowU")));
	}
...
void AZombieAIController::Chase(AMBs_GameCharacter* PlayerCharacter)
{
	...
	{	//Pass info of hit componentto debugger to be displayed on screen
		...
		GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Red, FString::Printf(TEXT("I'm CHASING YOU")));
	}
...
void AZombieAIController::StopChase()
{
	...
	{	//Pass info of hit componentto debugger to be displayed on screen
		...
		GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Red, FString::Printf(TEXT("Shoot! I lost em!!")));
	}
...
void AZombieAIController::IdleOrRoam()
{
	if (Zombie_Cow->bCanRoam)
	{
		...
		if (Zombie_Cow->PreviousState == ZombieStates::CHASE)
		{
			...
			{	//Pass info of hit componentto debugger to be displayed on screen
				...
				GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Red, FString::Printf(TEXT("I WAS chasing, now I'm going to roam")));
			}
	...
	else
	{
		...
		{	//Pass info of hit componentto debugger to be displayed on screen
			...
			GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Red, FString::Printf(TEXT("I'm idling")));
		}
		Zombie_Cow->ToIdleState();
	}
}
