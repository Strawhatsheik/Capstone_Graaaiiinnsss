...
// Cross Module References
	MBS_GAME_API UClass* Z_Construct_UClass_UHealthBar_NoRegister();
	MBS_GAME_API UClass* Z_Construct_UClass_UHealthBar();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UHealthBar_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UHealthBar_Statics::PropPointers),
		0,
		0x00B010A1u,
		METADATA_PARAMS(Z_Construct_UClass_UHealthBar_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UHealthBar_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UHealthBar, 3551954878);
	template<> MBS_GAME_API UClass* StaticClass<UHealthBar>()
	{
		return UHealthBar::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UHealthBar(Z_Construct_UClass_UHealthBar, &UHealthBar::StaticClass, TEXT("/Script/MBs_Game"), TEXT("UHealthBar"), false, nullptr, nullptr, nullptr);
